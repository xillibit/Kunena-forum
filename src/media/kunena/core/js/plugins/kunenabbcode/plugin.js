...
( function() {
	...
	var bbcodeMap = { b: 'strong', u: 'u', i: 'em', s: 's', color: 'span', size: 'span', left: 'div', right: 'div', center: 'div', justify: 'div', quote: 'blockquote', code: 'code', url: 'a', email: 'span', img: 'span', '*': 'li', list: 'ol' },
		...
		attributesMap = { url: 'href', email: 'mailhref', quote: 'cite', list: 'listType', img: 'height', img: 'width' };
	...
	CKEDITOR.plugins.add( 'kunenabbcode', {
		requires: 'entities',
					...
					span: function( element ) {
						...
						if ( ( bbcode = element.attributes.bbcode ) ) {
							if ( bbcode == 'img' ) {
								...
								var tempImageSize = element.attributes.width;
								var imageSizes = tempImageSize.split("x");
								element.attributes.height = imageSizes[0];
								element.attributes.width = imageSizes[1];
								element.children = [];
